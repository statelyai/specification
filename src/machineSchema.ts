...
export const invokeSchema = z.object({
  ...
  onDone: z.union([z.array(transitionSchema), transitionSchema]).optional(),
  onError: z.union([z.array(transitionSchema), transitionSchema]).optional(),
});
...
export const stateSchema = z.object({
  ...
  on: z
    .record(z.string(), z.union([z.array(transitionSchema), transitionSchema]))
    .optional()
  ...
  always: z
    .union([z.array(transitionSchema), transitionSchema])
    .optional()
    .describe(
...
export const atomicState = baseState.extend({
  ...
  after: z
    .record(z.string(), z.union([z.array(transitionSchema), transitionSchema]))
    .optional(),
  always: z.union([z.array(transitionSchema), transitionSchema]).optional(),
